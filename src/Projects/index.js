  ...
  return (
    <div className="projects">
      ...
      <div className="projects__section">
        <div className="projects__section__project">
          <Fade left>
            <p className="projects__section__project__description">Une application de météo dynamique permettant d'avoir la température et le temps qu'il fait dans le monde entier.</p>
            <ul className="projects__section__project__lists">Technologies
        ...
        <div className="projects__section__project__links">
          <Fade right>
            <a className="projects__section__project__links__link" href="https://react-weather-site.netlify.app/" target="_blank">Weather<img className="projects__section__project__links__img img-weather" src={WeatherImg} alt="site d'une application météo." /></a>
          </Fade>
        </div>
      </div>
      <div className="projects__section">
